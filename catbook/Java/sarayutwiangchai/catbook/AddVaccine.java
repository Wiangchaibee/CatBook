...
public class AddVaccine extends ActionBarActivity
        ...
        OK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(AddVaccine.this);
                ...
                builder.setPositiveButton(getString(android.R.string.ok),
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                addVaccineData vaccine = new addVaccineData();
                                vaccine.setName(Names.getText().toString());


                                if (ID == -1) {
                                    connect.addVaccineData(vaccine);
                                    final Intent  intent = new Intent(AddVaccine.this, Vaccine.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.add_vaccine, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((AddVaccine) activity).onSectionAttached(
