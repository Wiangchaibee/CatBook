...
public class CatList extends ListActivity
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent detail = new Intent(this, CatDetail.class);
        String listName = cats.get(position);
        int index = listName.indexOf(" ");
        String columnId = listName.substring(0, index);

        detail.putExtra(myCatData.Column.ID, columnId);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((CatList) activity).onSectionAttached(
